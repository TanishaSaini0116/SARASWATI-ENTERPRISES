...
export const IndustryCard = ({ industry }: { industry: Industry }) => {
  return (
    <div className="group relative bg-brand-navy rounded-2xl overflow-hidden shadow-lg h-[400px]">
      <Image
        src={industry.image}
        alt={industry.name}
        fill
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-t from-brand-navy via-brand-navy/80 to-transparent p-8 flex flex-col justify-end transform transition-transform duration-500">
