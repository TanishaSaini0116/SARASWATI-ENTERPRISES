      ...
      {items.map((item, i) => {
        ...
        return (
          <Tag
            ...
            className="group relative block min-w-0 min-h-0 flex-[1_1_0] cursor-pointer overflow-hidden bg-text no-underline outline-none [transform-style:preserve-3d] [transform-origin:center] [box-shadow:0_10px_30px_-18px_rgba(0,0,0,0.8)] focus-visible:[box-shadow:0_0_0_2px_var(--ag-accent),0_10px_30px_-18px_rgba(0,0,0,0.8)] max-[520px]:min-h-[84px] max-[520px]:!transform-none"
            style={
              {
          ...
          >
            ...
            {showLabels && (
              <span
                className="pointer-events-none absolute bottom-5 left-5 right-5 z-[2] flex flex-col items-start gap-1"
                aria-hidden="true"
              >
                <span
                  ref={(el: HTMLElement | null) => {
                  ...
                  className="h-[3px] w-8 flex-none rounded-[3px] opacity-0 mb-2"
                  style={{
                ...
                <span
                  ...
                  className="overflow-hidden whitespace-normal text-left text-[clamp(1rem,1.4vw,1.4rem)] font-medium tracking-[0.01em] opacity-0 [text-shadow:0_2px_14px_rgba(0,0,0,0.55)]"
