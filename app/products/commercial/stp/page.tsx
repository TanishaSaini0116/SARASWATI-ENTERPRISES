    ...
    <>
      <SectionWrapper bg="navy" className="pt-32 pb-20">
        <div className="max-w-4xl mx-auto text-center text-white">
          <h1 className="text-4xl md:text-5xl font-heading font-bold mb-6">Commercial STP</h1>
          <p className="text-lg text-text-muted mb-8">
            Engineered for reliability, efficiency, and compliance. Our Commercial STP solutions are custom-built to meet the exact specifications of your facility.
          </p>
      ...
      <SectionWrapper bg="white" className="py-20">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="relative h-[400px] rounded-2xl overflow-hidden shadow-xl">
            <Image src="https://placehold.co/800x600/6C9BB0/F6F4EF?text=Commercial%20STP" alt="Commercial STP" fill className="object-cover" />
          </div>
          
          <div>
            <h2 className="text-3xl font-heading font-bold text-primary mb-6">System Overview</h2>
            <p className="text-text-muted mb-6 leading-relaxed">
              The Commercial STP from Saraswati Enterprises represents the pinnacle of modern water treatment engineering. Designed utilizing advanced simulation tools and high-grade materials, this system ensures consistent performance even under fluctuating feed conditions.
            </p>
            <p className="text-text-muted mb-8 leading-relaxed">
              Whether you are looking to upgrade an existing facility or implement a greenfield project, our expert engineering team will size, design, and commission the perfect Commercial STP to optimize your operational expenditures while meeting all regulatory frameworks.
            </p>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <span className="text-text-secondary">Underground installation</span>
              </li>
              <li className="flex items-start">
                <CheckCircle2 className="w-6 h-6 text-green-accent shrink-0 mr-3" />
                <span className="text-text-secondary">Packaged system</span>
              </li>
              <li className="flex items-start">
                <CheckCircle2 className="w-6 h-6 text-green-accent shrink-0 mr-3" />
                <span className="text-text-secondary">Silent blowers</span>
              </li>
              <li className="flex items-start">
                <CheckCircle2 className="w-6 h-6 text-green-accent shrink-0 mr-3" />
                <span className="text-text-secondary">Green building compliant</span>
              </li>
              <li className="flex items-start">
                <CheckCircle2 className="w-6 h-6 text-green-accent shrink-0 mr-3" />
                <span className="text-text-secondary">Auto sludge removal</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <SectionWrapper bg="gray" className="py-20">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-text-muted">Standard operating parameters for our Commercial STP series.</p>
          </div>
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-gray-100">
                ...
                <tr className="hover:bg-soft-bg transition-colors">
                  ...
                  <td className="p-4 text-text-muted">400 - 54000 LPH</td>
                </tr>
                <tr className="hover:bg-soft-bg transition-colors">
                  <td className="p-4 font-medium text-text-secondary">Power Consumption</td>
                  <td className="p-4 text-text-muted">3.9 kW - 24.5 kW</td>
                </tr>
                <tr className="hover:bg-soft-bg transition-colors">
                ...
                <tr className="hover:bg-soft-bg transition-colors">
                  ...
                  <td className="p-4 text-text-muted">2 - 19 Bar</td>
                </tr>
              </tbody>
            </table>
          </div>
