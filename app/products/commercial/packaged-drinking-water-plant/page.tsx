      ...
      <SectionWrapper bg="white" className="py-20">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="relative h-[400px] rounded-2xl overflow-hidden shadow-xl">
            <Image src="https://placehold.co/800x600/6C9BB0/F6F4EF?text=Packaged%20Drinking%20Water%20Plant" alt="Packaged Drinking Water Plant" fill className="object-cover" />
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <span className="text-text-secondary">Turnkey solution</span>
              </li>
              <li className="flex items-start">
                <CheckCircle2 className="w-6 h-6 text-green-accent shrink-0 mr-3" />
                <span className="text-text-secondary">BISI standard</span>
              </li>
              <li className="flex items-start">
                <CheckCircle2 className="w-6 h-6 text-green-accent shrink-0 mr-3" />
                <span className="text-text-secondary">Bottle washing</span>
              </li>
              <li className="flex items-start">
                <CheckCircle2 className="w-6 h-6 text-green-accent shrink-0 mr-3" />
                <span className="text-text-secondary">Filling machine</span>
              </li>
              <li className="flex items-start">
                <CheckCircle2 className="w-6 h-6 text-green-accent shrink-0 mr-3" />
                <span className="text-text-secondary">Ozonation</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <SectionWrapper bg="gray" className="py-20">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-text-muted">Standard operating parameters for our Packaged Drinking Water Plant series.</p>
          </div>
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-gray-100">
                ...
                <tr className="hover:bg-soft-bg transition-colors">
                  ...
                  <td className="p-4 text-text-muted">100 - 88000 LPH</td>
                </tr>
                <tr className="hover:bg-soft-bg transition-colors">
                  <td className="p-4 font-medium text-text-secondary">Power Consumption</td>
                  <td className="p-4 text-text-muted">2.7 kW - 29.7 kW</td>
                </tr>
                <tr className="hover:bg-soft-bg transition-colors">
                ...
                <tr className="hover:bg-soft-bg transition-colors">
                  ...
                  <td className="p-4 text-text-muted">2 - 18 Bar</td>
                </tr>
              </tbody>
            </table>
          </div>
