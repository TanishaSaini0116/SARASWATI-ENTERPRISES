      ...
      <SectionWrapper bg="white" className="py-20">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="relative h-[400px] rounded-2xl overflow-hidden shadow-xl">
            <Image src="https://placehold.co/800x600/26495C/F6F4EF?text=Ultrafiltration%20(UF)%20System" alt="Ultrafiltration (UF) System" fill className="object-cover" />
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <span className="text-text-secondary">Hollow fiber membrane</span>
              </li>
              <li className="flex items-start">
                <CheckCircle2 className="w-6 h-6 text-green-accent shrink-0 mr-3" />
                <span className="text-text-secondary">High flux rate</span>
              </li>
              <li className="flex items-start">
                <CheckCircle2 className="w-6 h-6 text-green-accent shrink-0 mr-3" />
                <span className="text-text-secondary">Turbidity removal</span>
              </li>
              <li className="flex items-start">
                <CheckCircle2 className="w-6 h-6 text-green-accent shrink-0 mr-3" />
                <span className="text-text-secondary">Backwash automation</span>
              </li>
              <li className="flex items-start">
                <CheckCircle2 className="w-6 h-6 text-green-accent shrink-0 mr-3" />
                <span className="text-text-secondary">Pre-treatment for RO</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <SectionWrapper bg="gray" className="py-20">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-text-muted">Standard operating parameters for our Ultrafiltration (UF) System series.</p>
          </div>
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-gray-100">
                ...
                <tr className="hover:bg-soft-bg transition-colors">
                  ...
                  <td className="p-4 text-text-muted">200 - 77000 LPH</td>
                </tr>
                <tr className="hover:bg-soft-bg transition-colors">
                  <td className="p-4 font-medium text-text-secondary">Power Consumption</td>
                  <td className="p-4 text-text-muted">5.5 kW - 11.4 kW</td>
                </tr>
                <tr className="hover:bg-soft-bg transition-colors">
                ...
                <tr className="hover:bg-soft-bg transition-colors">
                  ...
                  <td className="p-4 text-text-muted">3 - 18 Bar</td>
                </tr>
              </tbody>
            </table>
          </div>
