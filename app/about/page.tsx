      ...
      <SectionWrapper bg="white">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="text-lg font-bold text-brand-blue uppercase tracking-wider mb-8">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-gray-100 h-64 rounded-2xl bg-cover bg-center" style={{ backgroundImage: "url('https://placehold.co/400x400/0B3D6E/FFF?text=Manufacturing')" }}></div>
            <div className="bg-gray-100 h-64 rounded-2xl mt-12 bg-cover bg-center" style={{ backgroundImage: "url('https://placehold.co/400x400/4CAF50/FFF?text=Our+Team')" }}></div>
          </div>
        </div>
      </SectionWrapper>

      <SectionWrapper bg="gray" className="text-center">
        <h2 className="text-3xl font-bold text-brand-navy mb-12">Meet the Leadership</h2>
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {[
            ...
            <div key={i} className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
              ...
              <h4 className="text-xl font-bold text-brand-navy mb-1">{leader.name}</h4>
