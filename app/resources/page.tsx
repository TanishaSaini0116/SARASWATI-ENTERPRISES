  ...
  return (
    <SectionWrapper bg="gray" className="min-h-screen pt-32">
      <div className="text-center max-w-3xl mx-auto mb-16">
        <h1 className="text-4xl md:text-5xl font-bold text-primary mb-6">Resources & Insights</h1>
      ...
      <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        {blogs.map((blog, idx) => (
          <div key={idx} className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col h-full group hover:shadow-lg transition-all duration-300">
            <div className="inline-block bg-green-accent/10 text-green-accent font-semibold text-xs px-3 py-1 rounded-full mb-4 w-fit">
              {blog.category}
            </div>
