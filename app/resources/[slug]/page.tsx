  ...
  return (
    <SectionWrapper bg="white" className="pt-32">
      <div className="max-w-3xl mx-auto">
        <div className="inline-block bg-brand-blue/10 text-brand-blue font-semibold text-xs px-3 py-1 rounded-full mb-6 w-fit uppercase tracking-wider">
          Article
        </div>
        <h1 className="text-4xl md:text-5xl font-bold text-brand-navy mb-6 capitalize leading-tight">
        ...
        <div className="prose prose-lg max-w-none text-gray-600 mb-16">
          ...
          <h2 className="text-2xl font-bold text-brand-navy mb-4 mt-8">The Core Problem</h2>
          <p className="mb-6">
          ...
          <h2 className="text-2xl font-bold text-brand-navy mb-4 mt-8">Key Considerations</h2>
        ...
        <div className="bg-brand-navy text-white p-8 md:p-12 rounded-2xl text-center">
          ...
          <p className="text-gray-300 mb-8">Our engineers are available for a free consultation regarding your specific water treatment needs.</p>
