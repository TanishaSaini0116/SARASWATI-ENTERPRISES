      ...
      <SectionWrapper bg="white" className="py-20">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="relative h-[400px] rounded-2xl overflow-hidden shadow-xl">
            <Image src="https://placehold.co/800x600/D9C9A3/F6F4EF?text=Hotel%20Water%20Solutions" alt="Hotel Water Solutions" fill className="object-cover" />
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <span className="text-text-secondary">Guest room RO</span>
              </li>
              <li className="flex items-start">
                <CheckCircle2 className="w-6 h-6 text-green-accent shrink-0 mr-3" />
                <span className="text-text-secondary">Kitchen filtration</span>
              </li>
              <li className="flex items-start">
                <CheckCircle2 className="w-6 h-6 text-green-accent shrink-0 mr-3" />
                <span className="text-text-secondary">Swimming pool filters</span>
              </li>
              <li className="flex items-start">
                <CheckCircle2 className="w-6 h-6 text-green-accent shrink-0 mr-3" />
                <span className="text-text-secondary">Boiler feed water</span>
              </li>
              <li className="flex items-start">
                <CheckCircle2 className="w-6 h-6 text-green-accent shrink-0 mr-3" />
                <span className="text-text-secondary">Sewage recycling</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <SectionWrapper bg="gray" className="py-20">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-text-muted">Standard operating parameters for our Hotel Water Solutions series.</p>
          </div>
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-gray-100">
                ...
                <tr className="hover:bg-soft-bg transition-colors">
                  ...
                  <td className="p-4 text-text-muted">200 - 60000 LPH</td>
                </tr>
                <tr className="hover:bg-soft-bg transition-colors">
                  <td className="p-4 font-medium text-text-secondary">Power Consumption</td>
                  <td className="p-4 text-text-muted">5.5 kW - 24.6 kW</td>
                </tr>
                <tr className="hover:bg-soft-bg transition-colors">
                ...
                <tr className="hover:bg-soft-bg transition-colors">
                  ...
                  <td className="p-4 text-text-muted">6 - 11 Bar</td>
                </tr>
              </tbody>
            </table>
          </div>
