      ...
      <SectionWrapper bg="white" className="py-20">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="relative h-[400px] rounded-2xl overflow-hidden shadow-xl">
            <Image src="https://placehold.co/800x600/0E3B45/F6F4EF?text=Desalination%20Plant" alt="Desalination Plant" fill className="object-cover" />
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-700">Sea water RO</span>
              </li>
              <li className="flex items-start">
                <CheckCircle2 className="w-6 h-6 text-brand-green shrink-0 mr-3" />
              ...
              <li className="flex items-start">
                <CheckCircle2 className="w-6 h-6 text-brand-green shrink-0 mr-3" />
                <span className="text-gray-700">Energy efficient pumps</span>
              </li>
              <li className="flex items-start">
                <CheckCircle2 className="w-6 h-6 text-brand-green shrink-0 mr-3" />
                <span className="text-gray-700">High pressure operation</span>
              </li>
              <li className="flex items-start">
                <CheckCircle2 className="w-6 h-6 text-brand-green shrink-0 mr-3" />
                <span className="text-gray-700">Containerized options</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <SectionWrapper bg="gray" className="py-20">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">Standard operating parameters for our Desalination Plant series.</p>
          </div>
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-gray-100">
                ...
                <tr className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="p-4 text-gray-600">200 - 81000 LPH</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="p-4 font-medium text-gray-700">Power Consumption</td>
                  <td className="p-4 text-gray-600">4.1 kW - 14.0 kW</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                ...
                <tr className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="p-4 text-gray-600">5 - 19 Bar</td>
                </tr>
              </tbody>
            </table>
          </div>
