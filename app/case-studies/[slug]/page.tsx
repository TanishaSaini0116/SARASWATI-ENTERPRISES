        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl">
            <div className="flex flex-wrap gap-4 mb-6">
              <span className="inline-flex items-center gap-2 bg-green-accent/20 text-green-accent font-semibold text-xs px-3 py-1 rounded-full border border-green-accent/30 uppercase tracking-wider">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            <div>
              ...
              <p className="text-text-muted text-lg leading-relaxed">{study.challenge}</p>
            </div>
            <div>
              <h2 className="text-2xl font-bold text-primary mb-4">Our Solution</h2>
              <p className="text-text-muted text-lg leading-relaxed">{study.solution}</p>
            </div>
          </div>

          <div className="bg-soft-bg rounded-2xl p-8 md:p-12 border border-gray-100 mb-16">
            <h2 className="text-2xl font-bold text-primary mb-8">Key Results</h2>
            <div className="grid sm:grid-cols-2 gap-6">
              {study.results.map((result, idx) => (
                <div key={idx} className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-green-accent shrink-0 mt-0.5" />
                  <span className="text-text-secondary font-medium text-lg leading-relaxed">{result}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="text-center">
            <h3 className="text-2xl font-bold text-primary mb-6">Facing similar challenges?</h3>
